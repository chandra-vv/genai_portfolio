...
# Gradio dashboard that runs the retrieval/answer evaluations from evaluation/eval.py
# over the full test set and displays color-coded metrics and per-category charts.
